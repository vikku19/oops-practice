...
int main()
{
    ...
    // For Cat class, instantiating catptr object 
    Animal* catptr = new Cat("Romeo",25.00);
...
//
    ...
    // For Cat class
    cout<<"Cat Making Noise: "<<(*catptr).makeNoise()<<endl;
    cout<<"Cat Making Noise: "<<catptr->makeNoise() <<endl;
    cout<<"Cat eating: "<<(*catptr).eat()<<endl;
    cout<<"Cat eating: "<<catptr->eat() <<endl;
    // To access the memeber functon of derived class using base class pointer
    // cat->chaseMouse(); //wouldn't work here because we're using Animal pointer to create an object of Cat
    cout<<"Cat chasing:\n";
    // Casting to cat pointer object , older method
